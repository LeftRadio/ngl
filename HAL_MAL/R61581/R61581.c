...
void R61581_SetCursor(uint16_t X, uint16_t Y) {
    /* Colum start - SC[8], SC[7:0] */
    R61581.WriteCommand(R61581.X_Register);
    R61581.WriteData((uint8_t)(X >> 8));
    R61581.WriteData((uint8_t)X);
    /* Row start - SR[8], SR[7:0] */
    R61581.WriteCommand(R61581.Y_Register);
    R61581.WriteData((uint8_t)(Y >> 8));
    R61581.WriteData((uint8_t)Y);
    /* */
    R61581.WriteCommand(0x2C);
}
...
void R61581_SetArea(uint16_t X0, uint16_t Y0, uint16_t X1, uint16_t Y1) {
    /* Colum start - SC[8], SC[7:0], Colum end - EC[8], EC[7:0]  */
    R61581.WriteCommand(R61581.X_Register);
    R61581.WriteData(X0 >> 8);
    R61581.WriteData(X0);
    R61581.WriteData(X1 >> 8);
    R61581.WriteData(X1);
    /* Row start - SR[8], SR[7:0], Row end - ER[8], ER[7:0]  */
    R61581.WriteCommand(R61581.Y_Register);
    R61581.WriteData(Y0 >> 8);
    R61581.WriteData(Y0);
    R61581.WriteData(Y1 >> 8);
    R61581.WriteData(Y1);
    /* */
    R61581.WriteCommand(0x2C);
}
...
void R61581_GetPixels(uint8_t *ReadData, uint16_t NumPixels) {
    ...
    for(i = 0; i < NumPixels/2; i++) {
        ...
        (*(ReadData+5)) = (uint8_t)((dummy & 0x00FF) >> 2);        // BLUE Second Pixel
        ReadData += 6;
    }
}
